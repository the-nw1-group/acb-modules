...
@ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO @ TODO
  ...
  .word         CBUS_on<xsl:value-of select="acronym"/> + 1<xsl:value-of select="f:repeat-string(' ', 41 - string-length(acronym))"/>@ Reserved for future use (<xsl:value-of select="opcode"/>)</xsl:when>
      <xsl:otherwise>
  .word         CBUS_on<xsl:value-of select="acronym"/> + 1<xsl:value-of select="f:repeat-string(' ', 41 - string-length(acronym))"/>@ <xsl:value-of select="description"/> (<xsl:value-of select="opcode"/>)</xsl:otherwise>
    </xsl:choose>
